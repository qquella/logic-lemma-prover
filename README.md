...
The Logic Lemma Prover is a web-based application that allows users to submit logical lemmas and receive automated proofs generated by a fine-tuned machine-learning model. It's meant to serve as a study tool for the CS course Logic and Computation, but it's not affiliated with Khoury College. Students should use it as a study tool for writing logical proofs.
