    ...
    >
      ...
      {showEmail && (
        ...
        >
          ...
          <a
            href="mailto:support@logiclemmaprover.com"
      ...
      <form onSubmit={handleSubmit} className="mb-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-4 px-6 py-2 text-lg font-semibold rounded-lg shadow-md transition bg-pumpkin-500 text-white hover:bg-pumpkin-700"
        >
